...
public final class LegacyJsonLdTestCase {

    public static final String TESTS_BASE = "https://w3c.github.io";

    public static final Predicate<LegacyJsonLdTestCase> IS_NOT_V1_0 = test -> !JsonLdVersion.V1_0.equals(test.options.version);
    ...
    public LegacyJsonLdTestCase(final String testsBase, final DocumentLoader loader) {
        this.testsBase = testsBase;
        this.loader = loader;
    }

    public static final LegacyJsonLdTestCase of(JsonObject o, String manifestUri, String manifestBase, String baseUri, final DocumentLoader loader) {

        final LegacyJsonLdTestCase testCase = new LegacyJsonLdTestCase(manifestBase, loader);
