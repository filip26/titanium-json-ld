...
import com.hasmac.jsonld.test.JsonLdManifestLoader;
import com.hasmac.jsonld.test.JsonLdMockServer;
import com.hasmac.jsonld.test.JsonLdTestCase;
import com.hasmac.jsonld.test.JsonLdTestRunnerJunit;
...
class HttpLoaderTest {
    ...
    void testMissingContentType() throws URISyntaxException, JsonLdError {
        ...
        final JsonLdTestCase testCase = JsonLdManifestLoader
                .load("/com/hasmac/jsonld/test/", "manifest.json", new ClasspathLoader())
                .stream()
    ...
    void execute(JsonLdTestCase testCase) {
        JsonLdMockServer server = new JsonLdMockServer(testCase, testCase.baseUri.substring(0, testCase.baseUri.length() - 1), "/com/hasmac/jsonld/test/", new ClasspathLoader());
