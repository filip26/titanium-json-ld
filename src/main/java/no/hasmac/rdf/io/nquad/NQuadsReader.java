...
public final class NQuadsReader implements RdfReader {
    ...
    private static <T> T unexpected(Token token, TokenType... types) throws RdfReaderException {
    ...
    private static void assertAbsoluteIri(final String iri, final String what) throws RdfReaderException {
