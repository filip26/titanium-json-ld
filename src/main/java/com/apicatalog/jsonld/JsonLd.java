...
public final class JsonLd {
    ...
    public static final Collection<?> expand(
        ...
        return expand(new Tree(document, JavaAdapter.instance()), options);
    }
    ...
    public static final Map<String, ?> compact(
        ...
        return compact(
                new Tree(document, JavaAdapter.instance()),
                new Tree(context, JavaAdapter.instance()),
                options);
    }
    ...
    public static final Map<String, ?> frame(
        ...
        return frame(
                new Tree(document, JavaAdapter.instance()),
                new Tree(frame, JavaAdapter.instance()),
                options);
    }
