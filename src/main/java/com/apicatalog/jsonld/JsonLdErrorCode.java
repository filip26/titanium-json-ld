...
/**
 * The {@link JsonLdErrorCode} represents the collection of valid JSON-LD error codes.
 * 
 * @see <a href="https://www.w3.org/TR/json-ld11-api/#jsonlderrorcode">JsonLdErrorCode Specification</a>
 * 
 */
public enum JsonLdErrorCode {

	/**
	 * Two <a href="https://www.w3.org/TR/rdf11-concepts/#dfn-property">properties</a> which expand 
	 * to the same keyword have been detected. This might occur if a keyword and an alias thereof are used at the same time.
	 */
	COLLIDING_KEYWORDS,
	/**
